...
# CUDA_VISIBLE_DEVICES=0 /home/admin/miniconda3/envs/easyFL/bin/python data_synthesized.py --adj_path "./data/distributed/erdos_renyi/d20_p0.11/adj.txt" --num_node 20 --p '0.11' --n 10 --s 2500 --mi 5 --di '10.0'
...
# CUDA_VISIBLE_DEVICES=0 /home/admin/miniconda3/envs/easyFL/bin/python data_synthesized.py --adj_path "./data/distributed/erdos_renyi/d40_p0.1/adj.txt" --num_node 40 --p '0.1' --n 10 --s 100000 --mi 5 --di '10.0'
